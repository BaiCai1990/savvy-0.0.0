...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'savvy_calibrate' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lv/catkin_ws/src/savvy_calibrate/${idir}'.  Ask the maintainer 'Lv Chaoshun <lvchaoshun@outlook.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lv/catkin_ws/src/savvy_calibrate/build/devel/lib;/home/lv/catkin_ws/devel/lib;/opt/ros/indigo/lib)
